    ...
    new MutationObserver((C) => {
        for (const ul of C)
            if (ul.type === 'childList')
                for (const vl of ul.addedNodes)
                    vl.tagName === 'LINK' && vl.rel === 'modulepreload' && o(vl)
    }).observe(document, { childList: !0, subtree: !0 })
    function K(C) {
        const ul = {}
        return (
            C.integrity && (ul.integrity = C.integrity),
            C.referrerPolicy && (ul.referrerPolicy = C.referrerPolicy),
...
function m1() {
    ...
    function K(o, C, ul) {
        ...
        if (
            (ul !== void 0 && (vl = '' + ul),
            C.key !== void 0 && (vl = '' + C.key),
            'key' in C)
        ) {
            ul = {}
            for (var Ol in C) Ol !== 'key' && (ul[Ol] = C[Ol])
        } else ul = C
        return (
            (C = ul.ref),
            {
    ...
    return (Ee.Fragment = J), (Ee.jsx = K), (Ee.jsxs = K), Ee
}
var jv
function o1() {
    return jv || ((jv = 1), (wc.exports = m1())), wc.exports
}
var tl = o1(),
    Wc = { exports: {} },
    G = {}
...
function r1() {
    ...
    ;(ht.constructor = pl), Ql(ht, Kl.prototype), (ht.isPureReactComponent = !0)
    var Jt = Array.isArray,
        k = { H: null, A: null, T: null, S: null },
        Cl = Object.prototype.hasOwnProperty
    function wt(s, T, q, R, O, V) {
        return (
            (q = V.ref),
            {
                $$typeof: A,
    ...
    function Zl(s, T, q, R, O) {
                ...
                case 'object':
                    switch (s.$$typeof) {
                        ...
                        case J:
                            ...
                            break
                        case $:
                            return (j = s._init), Zl(j(s._payload), T, q, R, O)
                    }
            }
        if (j)
            return (
        ...
        if (Jt(s))
            for (var P = 0; P < s.length; P++)
                (R = s[P]), (V = Gl + Mt(R, P)), (j += Zl(R, T, q, V, O))
        else if (((P = il(s)), typeof P == 'function'))
            for (s = P.call(s), P = 0; !(R = s.next()).done; )
                (R = R.value), (V = Gl + Mt(R, P++)), (j += Zl(R, T, q, V, O))
        else if (V === 'object') {
            if (typeof s.then == 'function') return Zl(Ut(s), T, q, R, O)
            throw (
                ((T = String(s)),
                Error(
    ...
    return (
        ...
        (G.cloneElement = function (s, T, q) {
            ...
            var R = Ql({}, s.props),
                ...
                V = void 0
            if (T != null)
                for (j in (T.ref !== void 0 && (V = void 0),
            ...
            if (j === 1) R.children = q
                ...
                for (var Gl = Array(j), P = 0; P < j; P++)
                    Gl[P] = arguments[P + 2]
                R.children = Gl
            }
            return wt(s.type, O, void 0, void 0, V, R)
        }),
        ...
        (G.createElement = function (s, T, q) {
            ...
            if (s && s.defaultProps)
                for (R in ((j = s.defaultProps), j))
                    O[R] === void 0 && (O[R] = j[R])
            return wt(s, V, void 0, void 0, null, O)
        }),
    ...
    return (
        Cv ||
            ...
            (function (A) {
                ...
                function ht(z) {
                    for (var p = K(E); p !== null; ) {
                        if (p.callback === null) o(E)
                        else if (p.startTime <= z)
                            o(E), (p.sortIndex = p.expirationTime), J(M, p)
                        else break
                        p = K(E)
                    }
                }
...
function E1() {
    ...
    return (
        ...
        (Bl.flushSync = function (M) {
            var E = vl.T,
                $ = o.p
            try {
                if (((vl.T = null), (o.p = 2), M)) return M()
            } finally {
                ;(vl.T = E), (o.p = $), o.d.f()
            }
        }),
        (Bl.preconnect = function (M, E) {
            typeof M == 'string' &&
                (E
                    ? ((E = E.crossOrigin),
                      (E =
        ...
        (Bl.prefetchDNS = function (M) {
            typeof M == 'string' && o.d.D(M)
        }),
        (Bl.preinit = function (M, E) {
                ...
                $ === 'style'
                    ? o.d.S(
                          ...
                          typeof E.precedence == 'string'
                              ? E.precedence
                              : void 0,
                          { crossOrigin: cl, integrity: il, fetchPriority: gl },
                      )
                    : $ === 'script' &&
                      o.d.X(M, {
                          crossOrigin: cl,
        ...
        (Bl.requestFormReset = function (M) {
            o.d.r(M)
        }),
        (Bl.unstable_batchedUpdates = function (M, E) {
            return M(E)
        }),
        (Bl.useFormState = function (M, E, $) {
            return vl.H.useFormState(M, E, $)
        }),
...
function T1() {
    ...
    return A(), (Pc.exports = E1()), Pc.exports
}
/**
 * @license React
...
` +
    ...
    function Oe(l) {
        Aa.current === l && (Sl(bt), Sl(Aa)),
            ze.current === l && (Sl(ze), (oe._currentValue = V))
    }
    ...
    var wl = Math.clz32 ? Math.clz32 : td,
        Iv = Math.log,
        ld = Math.LN2
    function td(l) {
    ...
    function ni(l, t, u) {
        ...
        ;(l.entangledLanes |= t),
            (l.entanglements[a] =
                l.entanglements[a] | 1073741824 | (u & 4194218))
    }
    function fi(l, t) {
    ...
    function ii() {
        ...
        return l !== 0
            ? l
            : ((l = window.event), l === void 0 ? 32 : Hv(l.type))
    }
    function ed(l, t) {
        var u = O.p
        try {
    ...
    var Ft = Math.random().toString(36).slice(2),
        ...
        Ma = '__reactMarker$' + Ft
    function Vn(l) {
        delete l[ql], delete l[xl], delete l[xn], delete l[nd], delete l[fd]
    }
    function Eu(l) {
        var t = l[ql]
        if (t) return t
    ...
    var zu = {
        ...
        Xe = F({}, Na, {
            ...
            movementX: function (l) {
                return 'movementX' in l
                    ...
                    : (l !== qa &&
                          (qa && l.type === 'mousemove'
                              ? ((Pn = l.screenX - qa.screenX),
                                (In = l.screenY - qa.screenY))
                              : (In = Pn = 0),
                          (qa = l)),
                      Pn)
            },
        ...
        _i = Vl(Xe),
        od = F({}, Xe, { dataTransfer: 0 }),
        rd = Vl(od),
        gd = F({}, Na, { relatedTarget: 0 }),
        lf = Vl(gd),
        Sd = F({}, zu, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
        bd = Vl(Sd),
        Ed = F({}, zu, {
    ...
    var Md = F({}, Na, {
        ...
        Nd = Vl(Hd),
        qd = F({}, zu, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
        Yd = Vl(qd),
        Bd = F({}, Xe, {
            deltaX: function (l) {
                return 'deltaX' in l
    ...
    function Je(l) {
        var t = Va
        return (Va += 1), aa === null && (aa = []), ns(aa, l, t)
    }
    function La(l, t) {
    ...
    function is(l) {
        ...
        function g(y, v, h, S, _) {
            return v === null || v.tag !== 7
                ? ((v = ju(h, y.mode, S, _)), (v.return = y), v)
                : ((v = e(v, h)), (v.return = y), v)
        }
        function b(y, v, h) {
            if (
            ...
            if (typeof v == 'object' && v !== null) {
                ...
                if (v.$$typeof === gl) return b(y, sn(y, v), h)
                we(y, v)
            }
            return null
        }
        function m(y, v, h, S) {
            ...
            if (typeof h == 'object' && h !== null) {
                ...
                if (R(h) || Cl(h))
                    return _ !== null ? null : g(y, v, h, S, null)
        ...
        function r(y, v, h, S, _) {
            ...
            if (typeof S == 'object' && S !== null) {
                switch (S.$$typeof) {
                    case vl:
                        return (
                            (y = y.get(S.key === null ? h : S.key) || null),
                            i(v, y, S, _)
                        )
                    case Ol:
                        return (
                    ...
                    case pl:
                        var Q = S._init
                        return (S = Q(S._payload)), r(y, v, h, S, _)
                }
                if (R(S) || Cl(S))
                    return (y = y.get(h) || null), g(v, y, S, _, null)
                if (typeof S.then == 'function') return r(y, v, h, Je(S), _)
                if (S.$$typeof === gl) return r(y, v, h, sn(v, S), _)
                we(v, S)
            }
            return null
        }
        function D(y, v, h, S) {
            for (
                var _ = null, Q = null, U = v, H = (v = 0), Ul = null;
                U !== null && H < h.length;
                H++
            ) {
        ...
        function ol(y, v, h, S) {
            if (
                ...
                switch (h.$$typeof) {
                    ...
                    case pl:
                        return (
                            (_ = h._init), (h = _(h._payload)), ol(y, v, h, S)
                        )
                }
                if (R(h)) return D(y, v, h, S)
                if (Cl(h)) {
                    if (((_ = Cl(h)), typeof _ != 'function'))
                        throw Error(o(150))
        ...
        return function (y, v, h, S) {
            try {
                ...
                if (U === Za) throw U
                var Q = vt(29, U, null, y.mode)
                return (Q.lanes = S), (Q.return = y), Q
            } finally {
            }
        }
    }
    ...
    function ds(l) {
        if (l.tag === 22) {
            if ((sl(zl, zl.current), sl(ct, l), zt === null)) {
                var t = l.alternate
    ...
    function tu() {
        sl(zl, zl.current), sl(ct, ct.current)
    }
    function Yt(l) {
    ...
    function os(l) {
        ...
        if (
            ((uu = 0), (bl = I = X = null), (Fe = !1), (wa = 0), (ia = null), t)
        )
            throw Error(o(300))
        l === null ||
            Dl ||
            ((l = l.dependencies), l !== null && cn(l) && (Dl = !0))
    }
    function rs(l, t, u, a) {
        X = l
        var e = 0
    ...
    function _f(l) {
        ...
        ;(uu = 0), (bl = I = X = null), (ca = !1), (wa = Pe = 0), (ia = null)
    }
    function Ll() {
        var l = {
            memoizedState: null,
    ...
    function gs(l, t, u) {
        ...
        if (
            ...
            e.getSnapshot !== t ||
                f ||
                (bl !== null && bl.memoizedState.tag & 1))
        ) {
            if (
                ((a.flags |= 2048),
    ...
    function As(l, t, u, a) {
        return (l.baseState = u), Mf(l, I, typeof a == 'function' ? a : Bt)
    }
    ...
    function Rs(l, t) {
        ...
        return (
            ...
            (a.dispatch = u),
            (a = Rf(!1)),
            (n = Gf.bind(null, X, !1, a.queue)),
            (a = Ll()),
            (e = { state: t, dispatch: null, action: l, pending: null }),
            (a.queue = e),
            (u = cy.bind(null, X, e, n, u)),
            (e.dispatch = u),
            (a.memoizedState = l),
            [t, u, !1]
        )
    ...
    function an(l, t, u, a) {
        ...
        I !== null && a !== null && Tf(a, I.memoizedState.deps)
            ? (e.memoizedState = sa(t, u, n, a))
            : ((X.flags |= l), (e.memoizedState = sa(1 | t, u, n, a)))
    }
    function Bs(l, t) {
        un(8390656, 8, l, t)
    }
    ...
    function Yf(l, t, u) {
        return u === void 0 || (uu & 1073741824) !== 0
            ? (l.memoizedState = t)
            : ((l.memoizedState = u), (l = x0()), (X.lanes |= l), (yu |= l), u)
    }
    function Zs(l, t, u, a) {
        return Wl(u, t)
            ? u
    ...
    var Nu = {
        ...
        useImperativeHandle: function (l, t, u) {
            ;(u = u != null ? u.concat([l]) : null),
                un(4194308, 4, js.bind(null, t, l), u)
        },
        ...
        useCacheRefresh: function () {
            return (Ll().memoizedState = vy.bind(null, X))
        },
    }
    ;(Nu.useMemoCache = Df),
    ...
    var qu = {
        ...
        useDeferredValue: function (l, t) {
            var u = El()
            return I === null ? Yf(u, l, t) : Zs(u, I.memoizedState, l, t)
        },
        useTransition: function () {
            var l = Uf(Bt)[0],
                t = El().memoizedState
            ...
            return (
                ...
                t !== null
                    ? ((t.flags & 65536) === 0 && (t.flags |= 256),
                      ...
                      (t.lanes = e),
                      a !== mf &&
                          ((l = Error(o(422), { cause: a })), Ca(et(l, u))))
                    : (a !== mf &&
                          ((t = Error(o(423), { cause: a })), Ca(et(t, u))),
    ...
    function n0(l, t, u, a, e) {
        ...
        return (
            ...
            l !== null && !Dl
                ? (Of(l, t, e), pt(l, t, e))
                : (w && c && yf(t), (t.flags |= 1), Hl(l, t, a, e), t.child)
        )
    }
    ...
    function c0(l, t, u, a, e) {
        if (l !== null) {
            ...
            if (Ga(n, a) && l.ref === t.ref)
                if (((Dl = !1), (t.pendingProps = a = n), Wf(l, e)))
    ...
    function Cf(l, t, u, a, e) {
        return (
            ...
            l !== null && !Dl
                ? (Of(l, t, e), pt(l, t, e))
                : (w && a && yf(t), (t.flags |= 1), Hl(l, t, u, e), t.child)
        )
    }
    function v0(l, t, u, a, e, n) {
        return (
            ...
            l !== null && !Dl
                ? (Of(l, t, n), pt(l, t, n))
                : (w && a && yf(t), (t.flags |= 1), Hl(l, t, u, n), t.child)
        )
    }
    function d0(l, t, u, a, e) {
        if ((pu(t), t.stateNode === null)) {
            ...
            typeof f == 'object' && f !== null && (n = Yl(f)),
                ...
                typeof f == 'function' &&
                    (jf(t, u, f, a), (n.state = t.memoizedState)),
    ...
    function r0(l, t, u) {
        if (l !== null)
            if (l.memoizedProps !== t.pendingProps) Dl = !0
                ...
                if (!Wf(l, u) && (t.flags & 128) === 0)
                    return (Dl = !1), hy(l, t, u)
                Dl = (l.flags & 131072) !== 0
            }
        else (Dl = !1), w && (t.flags & 1048576) !== 0 && ls(t, Le, t.index)
        switch (((t.lanes = 0), t.tag)) {
            ...
            case 1:
                return (
                    (a = t.type), (e = Yu(a, t.pendingProps)), d0(l, t, a, e, u)
                )
            case 3:
                l: {
            ...
            case 27:
                return (
                    ...
                    l === null &&
                        w &&
                        ((a = t.stateNode =
                            rv(t.type, t.pendingProps, $t.current)),
                        (jl = t),
                        (Tt = !0),
                        (Rl = gt(a.firstChild))),
            ...
            case 5:
                return (
                    l === null &&
                        w &&
                        ((e = a = Rl) &&
                            ((a = Vy(a, t.type, t.pendingProps, Tt)),
                            a !== null
                                ? ((t.stateNode = a),
                                  (jl = t),
                                  (Rl = gt(a.firstChild)),
    ...
    var $f = P(null),
        ...
        Gt = null
    function eu(l, t, u) {
        sl($f, t._currentValue), (t._currentValue = u)
    }
    function jt(l) {
    ...
    var Xt = !1,
        ...
        D0 = !1
    function my(l, t) {
        if (((l = l.containerInfo), (qc = Hn), (l = Vi(l)), nf(l))) {
        ...
        for (
            Yc = { focusedElem: l, selectionRange: u }, Hn = !1, Ml = t;
            Ml !== null;
        ...
        switch (l.tag) {
            ...
            case 5:
                ...
                a & 4 &&
                    l.stateNode != null &&
                    ((e = l.memoizedProps),
                    A0(l, e, u !== null ? u.memoizedProps : e)),
                    a & 1024 && (ec = !0)
                break
            case 6:
                if ((it(t, l), st(l), a & 4)) {
    ...
    function gy(l, t, u) {
        ...
        switch ((hf(t), t.tag)) {
            ...
            case 19:
                if ((Sl(zl), (e = t.memoizedState), e === null))
                    return dl(t), null
                if (
    ...
    function x0() {
        dt === 0 && (dt = (L & 536870912) === 0 || w ? ai() : 536870912)
        var l = ct.current
    ...
    function Xl(l, t, u) {
        ;((l === nl && fl === 2) || l.cancelPendingCommit !== null) &&
            ...
            ((yl & 2) === 0 || l !== nl) &&
                (l === nl &&
                    ((yl & 2) === 0 && (Xu |= u), ml === 4 && Lt(l, L, dt, !1)),
                _t(l))
    }
    function V0(l, t, u) {
        if ((yl & 6) !== 0) throw Error(o(327))
        var a =
                (!u && (t & 60) === 0 && (t & l.expiredLanes) === 0) ||
                _a(l, t),
            e = a ? Ay(l, t) : Tc(l, t, !0),
            n = a
        do {
            if (e === 0) {
                ...
                l: {
                    ...
                    if (
                        ...
                        if ((Lt(a, t, dt, !xt), Ue(a, 0) !== 0)) break l
                        a.timeoutHandle = hv(
                            L0.bind(
                                null,
                                a,
                    ...
                    L0(a, u, Ot, on, hc, t, dt, Xu, ma, xt, 0, -0, 0)
                }
            }
            break
        } while (!0)
    ...
    function L0(l, t, u, a, e, n, f, c, i, d, g, b, m) {
        ...
        if (
            ...
            ;(l.cancelPendingCommit = t(
                F0.bind(null, l, u, a, e, f, c, i, 1, b, m),
            )),
                Lt(l, n, f, !d)
            return
        }
    ...
    function gn() {
        return (yl & 6) === 0 ? (se(0), !1) : !0
    }
    function bc() {
        if (Z !== null) {
            if (fl === 0) var l = Z.return
            else
                (l = Z), (Gt = Bu = null), _f(l), (aa = null), (Va = 0), (l = Z)
                ...
                if (fl !== 0 && Z !== null) {
                    ...
                    t: switch (fl) {
                        ...
                        case 5:
                            ...
                            ;(fl = 0), (Fl = null), ra(l, t, n, 5)
                            break
                        case 6:
                            ;(fl = 0), (Fl = null), ra(l, t, n, 6)
                            break
                        case 8:
                            bc(), (ml = 6)
                            break l
    ...
    function $0(l) {
        ...
        switch (t.tag) {
            ...
            case 5:
                _f(t)
            default:
                Z0(u, t), (t = Z = X0(t, Vt)), (t = r0(u, t, Vt))
        }
        ;(l.memoizedProps = l.pendingProps), t === null ? Sn(l) : (Z = t)
    }
    function ra(l, t, u, a) {
        ;(Gt = Bu = null), _f(t), (aa = null), (Va = 0)
        var e = t.return
        try {
            if (yy(l, e, t, u, L)) {
    ...
    function F0(l, t, u, a, e, n, f, c, i, d) {
        var g = N.T,
            b = O.p
        try {
            ;(O.p = 2), (N.T = null), _y(l, t, u, a, b, e, n, f, c, i, d)
        } finally {
            ;(N.T = g), (O.p = b)
        }
    }
    ...
    function ga() {
        if (Qu !== null) {
            ...
            var u = ci(ce),
                ...
                e = O.p
            try {
                if (((O.p = 32 > u ? 32 : u), (N.T = null), Qu === null))
                    var n = !1
                else {
                    ;(u = rc), (rc = null)
                    var f = Qu,
                        c = ce
                    if (((Qu = null), (ce = 0), (yl & 6) !== 0))
                        throw Error(o(331))
                    var i = yl
                    if (
                        ((yl |= 4),
        ...
        zi(function () {
            ...
            l: {
                ...
                if (m !== void 0) {
                    ...
                    0 < B.length &&
                        ((m = new r(m, D, null, u, g)),
                        b.push({ event: m, listeners: B }))
                }
            }
            if ((t & 7) === 0) {
                l: {
                ...
                switch (((Q = d ? Ua(d) : window), l)) {
                    case 'focusin':
                        ;(Yi(Q) || Q.contentEditable === 'true') &&
                            ((Fu = Q), (ff = d), (ja = null))
                        break
                    case 'focusout':
                        ja = ff = Fu = null
                ...
                H &&
                    ...
                    0 < Q.length &&
                        ...
                        b.push({ event: H, listeners: Q }),
                        U
                            ? (H.data = U)
                            : ((U = qi(u)), U !== null && (H.data = U)))),
                    (U = Qd ? Cd(l, u) : Zd(l, u)) &&
...
`,
    ...
    function ll(l, t, u, a, e, n) {
        switch (u) {
            ...
            case 'start':
                ...
                break
            case 'popover':
                x('beforetoggle', l), x('toggle', l), Re(l, 'popover', a)
                break
            case 'xlinkActuate':
    ...
    function Nl(l, t, u) {
        ...
        for (c in u)
            u.hasOwnProperty(c) &&
                ((a = u[c]), a != null && ll(l, t, c, a, u, null))
    }
    function Xy(l, t, u, a) {
        switch (t) {
            case 'div':
    ...
    var Kt = O.d
    O.d = { f: Ky, r: Jy, D: wy, C: Wy, L: $y, m: ky, X: Py, S: Fy, M: Iy }
    function Ky() {
        var l = Kt.f(),
            t = gn()
        return l || t
        ...
        if ((t.count++, t.instance === null))
            switch (t.type) {
                ...
                case 'stylesheet':
                    ...
                    if (n)
                        return (
                            (t.state.loading |= 4), (t.instance = n), _l(n), n
                        )
                    ;(a = Ev(u)),
                        (e = yt.get(e)) && Xc(a, e),
            ...
            0 < l.count
                ? function (t) {
                      var u = setTimeout(function () {
                          if (
                              (l.stylesheets && Cc(l, l.stylesheets),
                              l.unsuspend)
                          ) {
                              var a = l.unsuspend
                              ;(l.unsuspend = null), a()
        ...
        if (Hn) {
            ...
            if (e === null) Hc(l, t, a, Nn, u), Nv(l, a)
                ...
                for (; e !== null; ) {
                    ...
                    if (
                        ((n = Vc(a)), n === null && Hc(l, t, a, Nn, u), n === e)
                    )
                        break
                    e = n
                }
    ...
    function qn(l) {
        ...
        for (var t = l.targetContainers; 0 < t.length; ) {
            ...
            if (u === null) {
                ...
                return (t = Vu(u)), t !== null && Rv(t), (l.blockedOn = u), !1
            t.shift()
        }
        return !0
    }
    ...
    function Yn(l, t) {
        l.blockedOn === t &&
            ...
            Kc ||
                ((Kc = !0),
                A.unstable_scheduleCallback(A.unstable_NormalPriority, d1)))
    }
    var Bn = null
    function Bv(l) {
        Bn !== l &&
    ...
    pn.prototype.unstable_scheduleHydration = function (l) {
        if (l) {
            ...
            for (
                var u = 0;
                u < gu.length && t !== 0 && t < gu[u].priority;
                u++
            );
...
function A1() {
    ...
    return A(), ($c.exports = z1()), $c.exports
}
var O1 = A1()
const _1 = ({ data: A }) =>
        tl.jsxs('div', {
            children: [
                tl.jsx('h2', { children: 'Companies' }),
                tl.jsx('table', {
                    children: tl.jsxs('tbody', {
                        children: [
                            tl.jsxs('tr', {
                                ...
                                children: [
                                    tl.jsx('th', { children: 'Name' }),
                                    tl.jsx('th', { children: 'Status' }),
                                    tl.jsx('th', {
                                        children: 'Application URL',
                                    }),
                                    tl.jsx('th', { children: 'Notes' }),
                                    tl.jsx('th', {
            ...
            children: [
                ...
                tl.jsx('ul', {
                    ...
                    children: A.map((J, K) =>
                        tl.jsx(
                            'li',
                            { className: 'contacts-items', children: J },
                            K,
                        ),
                    ),
                }),
...
function M1() {
    ...
    return tl.jsxs(tl.Fragment, {
        children: [
            tl.jsx('h1', { children: 'Job Hitlist' }),
            tl.jsx(_1, { data: A }),
            tl.jsx(D1, { contacts: A.map((J) => J.contact) }),
        ],
    })
}
O1.createRoot(document.getElementById('root')).render(
    tl.jsx(g1.StrictMode, { children: tl.jsx(M1, {}) }),
)
